...
model.add(Flatten(input_shape=(60,60,1)))
...
history = model.fit(X_train, y_train, epochs=10, batch_size=128, verbose=1, validation_split=0.05)
model.save('Stacked-GRU_model.h5')
